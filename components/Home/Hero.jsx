...
const Hero = () => {
  return (
    <section className="py-7 md:py-10 relative">
      ...
      <p className="text-[#A1A1A1] font-medium text-[16px] md:text-[24px] leading-[28px] md:leading-[42px] mt-8 md:mt-14 mb-8 md:mb-14 max-w-[39.5rem] lg:max-w-[37rem] xl:max-w-[39.5rem]">
        Unlock a world of expertise, resources, and collaboration to elevate
        your practice in drug safety.
      </p>
      <Link className="text-white text-[14px] md:text-[20px] px-5 md:px-9 py-2 md:py-2.5 rounded-3xl bg-gradient-to-r from-[#56E9EE] to-[#016E92]"
        href={"/login"}>
        Get Started Today
      </Link>
